...
// System.Threading.ApartmentState
    ...
    {
    public:
        static std::string GetName(Il2CppThread* thread);
        ...
        static ThreadApartmentState GetApartmentState(Il2CppThread* thread);
        static bool SetApartmentState(Il2CppThread* thread, ThreadApartmentState state, bool throwOnError);

        static void CheckCurrentThreadForUserAPCAndHandle();
    ...
    public:
        ...
        static bool TestState(Il2CppThread* thread, ThreadState value);

        static void Stop(Il2CppThread* thread);
